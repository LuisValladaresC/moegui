...
// Path level function
module.exports.pathLevel = (file, languages = false) => {
  ...
  if (languages) {
    ...
    for (var language in languages) {
      if (file.relative.startsWith(language + '/') || file.relative.startsWith(language + '\\')) langPrefix = '/' + language
    }
    level = level + langPrefix;
  }
