...
function watch() {
  ...
  gulp.watch([
    ...
    paths.data.es || '',
    paths.data.pt || '',
  ], gulp.series(copyFilesToConfiguredLanguages, fileIncludeAll, browserSyncReload));
}

gulp.task('default', gulp.series(clean, copyFilesToConfiguredLanguages, fileIncludeAll, svgCompiler, scss, browserSync, watch))
