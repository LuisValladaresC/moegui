...
*/
"use strict";function filterObjectsBySearch(t,e,s=null){let a=[];return e.map(e=>{for(const i in e)if((!(Array.isArray(s)&&s.length>=1)||s.includes(i))&&"string"==typeof e[i]){if(e[i].trim().toLowerCase().includes(t.trim().toLowerCase())){a.push(e);break}}}),a}
/*
* HSSelect2 Plugin
